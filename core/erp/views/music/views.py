...
from core.erp.forms import MusicForm
from core.erp.mixins import ValidatePermissionRequiredMixin
from core.erp.models import Music
...
class MusicListView(LoginRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = 'Listado de Músicas'
        context['create_url'] = reverse_lazy('erp:music_create')
        context['list_url'] = reverse_lazy('erp:music_list')
...
class MusicCreateView(LoginRequiredMixin, CreateView):
    ...
    success_url = reverse_lazy('erp:music_list')
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = 'Creación una Música'
        context['entity'] = 'Musica'
...
class MusicUpdateView(LoginRequiredMixin, UpdateView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = 'Edición un Música'
        context['entity'] = 'Música'
        context['list_url'] = self.success_url
        context['action'] = 'edit'
        return context
...
class MusicDeleteView(LoginRequiredMixin,  DeleteView):
    ...
    success_url = reverse_lazy('erp:music_list')
    permission_required = 'delete_music'
    url_redirect = success_url
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = 'Eliminación de una Música'
        context['entity'] = 'Música'
        context['list_url'] = self.success_url
        return context
